...
namespace PriorState.Data.Migrations
{
    ...
    [Migration("20260917081638_AddApiSourceExecutions")]
    partial class AddApiSourceExecutions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PriorState.Domain.Entities.SourceExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RunId", "BindingId")
                        .IsUnique()
                        .HasFilter("\"RunId\" IS NOT NULL");

                    b.HasIndex("State", "QueuedAt");

                    b.ToTable("source_executions", (string)null);
                });
            ...
            modelBuilder.Entity("PriorState.Domain.Entities.SourceExecution", b =>
                {
                    b.HasOne("PriorState.Domain.Entities.PluginBindingVersion", "Binding")
                        .WithMany()
